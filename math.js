...
var allQuestions = [
  ...
  {
    question:
      "The probability of getting a spade card from a well shuffled deck of 52 cards is",
    choices: ["1/13", "1/4", "12/13", "3/4"],
    answer: 1,
  },
  {
    question:
      "In 2014, 200 workers received pays on hourly basis from $15/hour to $25/hour according to the difficulty of assigned tasks. The largest possible amount paid to the workers for 8 working hours is",
    choices: ["$215", "$165", "$200", "$170"],
    answer: 2,
  },
  {
    question:
      "In 2018, 200 workers received pays on hourly basis from $15/hour to $25/hour according to the difficulty of assigned tasks. The least possible amount paid to the workers for 10 working hours is",
    choices: ["$180", "$150", "$140", "$110"],
    answer: 1,
  },
  {
    question:
  ...
  },
  {
    ...
    choices: ["78°", "72°", "63.64°", "65°"],
    answer: 1,
  },
  {
    question: "By solving the following xy^8⁄xy^4",
    choices: ["y^-4", "1/y^-4", "1/y^4", "1/y^y-3"],
    answer: 1,
  },
];
